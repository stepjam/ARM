...
class PrioritizedReplayBuffer(UniformReplayBuffer):
    ...
    def get_storage_signature(
        ...
        storage_elements, obs_elements = super(PrioritizedReplayBuffer,
    ...
    def add(self, action, reward, terminal, timeout, priority=None, **kwargs):
        ...
        super(PrioritizedReplayBuffer, self).add(action, reward, terminal,
                                                 timeout, **kwargs)
    ...
    def sample_transition_batch(self,
        ...
        transition = super(PrioritizedReplayBuffer,
                           self).sample_transition_batch(batch_size,
                                                         indices,
                                                         pack_in_dict=False)
        ...
        # print('transition_names', transition_names)
    ...
    def get_transition_elements(self, batch_size=None):
        ...
        parent_transition_type = (super(
            PrioritizedReplayBuffer, self).get_transition_elements(batch_size))
        probablilities_type = [
